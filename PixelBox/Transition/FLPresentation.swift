//
//  FLPresentation.swift
//  FleetWatcher
//
//  Created by Justin Madewell on 1/16/18.
//  Copyright © 2018 Earthwave. All rights reserved.
//
...
// MARK: - FLPresentationController
final class FLPresentationController: UIPresentationController {
...
// MARK: - Dimming View
private extension FLPresentationController {
...
final class FLPresentationTransitioningDelegate: NSObject {
    var descriptor: PresentationAnimationDescriptor = .defaultDescriptor()
}

extension FLPresentationTransitioningDelegate: UIViewControllerTransitioningDelegate {
    
    func presentationController(forPresented presented: UIViewController, presenting: UIViewController?, source: UIViewController) -> UIPresentationController? {
        let presentationController = FLPresentationController(presented, presenting, descriptor)
    ...
    func animationController(forPresented presented: UIViewController, presenting: UIViewController, source: UIViewController) -> UIViewControllerAnimatedTransitioning? {
        return FLPresentationAnimator(true,descriptor)
    }
    
    func animationController(forDismissed dismissed: UIViewController) -> UIViewControllerAnimatedTransitioning? {
        return FLPresentationAnimator(false,descriptor)
    }
}

extension FLPresentationTransitioningDelegate: UIAdaptivePresentationControllerDelegate {
...
// MARK: - FLPresentationAnimator (Reusable Animator Class)
final class FLPresentationAnimator: NSObject {
